...
const jsonSchemaValidation = require('./jsonSchemaValidation')
...
Before(function(scenario){
    this.attach('Execute Before Hook')
...
After(function(scenario){
    this.attach('Execute After Hook')
...
class baseWorld extends World {
    constructor({ attach, log, parameters }){
        ...
        this.jsonSchemaValidation = new jsonSchemaValidation(attach, log, parameters)
    }

    _setHostUri(){
        return envConfig.getHost().concat(envConfig.getUri())
    }
